...
public class ReservationTest {
	...
	@Test()
	public void testShouldGetNumberOfBookedTickets() throws AlreadyReservedException, ProjectionNotFoundException,
			InvalidSeatException, ExpiredProjectionException, ReservationNotFoundException {
	...
	@Test()
	public void testShouldCheckIfFreeSeatsInProjectionDecreaseWhenTicketIsBooked() throws AlreadyReservedException,
	...
	public void testShouldThrowProjectionNotFoundExceptionWhileBookingTicket() throws AlreadyReservedException,
			ProjectionNotFoundException, InvalidSeatException, ExpiredProjectionException {
	...
	public void testShouldThrowExpiredProjectionExceptionWhileBookingTicket() throws AlreadyReservedException,
			ProjectionNotFoundException, InvalidSeatException, ExpiredProjectionException {
		set1.add(projection2);
	...
	public void testShouldThrowInvalidSeatExceptionWhileBookingTicket() throws AlreadyReservedException,
			ProjectionNotFoundException, InvalidSeatException, ExpiredProjectionException {
		set1.add(projection);
		program.put(movie, set1);
	...
	public void testShouldThrowAlreadyReservedTicketExceptionWhileBookingTicket() throws AlreadyReservedException,
			ProjectionNotFoundException, InvalidSeatException, ExpiredProjectionException {
		set1.add(projection);
		program.put(movie, set1);
		reservationSystem.bookTicket(ticket3);
	...
	@Test(expected = ProjectionNotFoundException.class)
	public void testShouldThrowProjectionNotFoundExceptionWhileCancellingTicket()
			throws AlreadyReservedException, ProjectionNotFoundException, InvalidSeatException,
			ExpiredProjectionException, ReservationNotFoundException {
		set1.add(projection);
		program.put(movie, set1);
	...
	public void testShouldThrowReservationNotFoundExceptionWhileCancellingTicket()
			throws AlreadyReservedException, ProjectionNotFoundException, InvalidSeatException,
			ExpiredProjectionException, ReservationNotFoundException {
		set1.add(projection2);
		program.put(movie2, set1);
	...
	@Test()
	public void testShouldGetProjectionFreeSeats() throws AlreadyReservedException, ProjectionNotFoundException,
	...
	@Test(expected = ProjectionNotFoundException.class)
	public void testShouldThrowProjectionNotFoundExceptionWhileGettingFreeSeats() throws AlreadyReservedException,
			ProjectionNotFoundException, InvalidSeatException, ExpiredProjectionException {
		set1.add(projection2);
		program.put(movie2, set1);
		reservationSystem.bookTicket(ticket2);
